...
See [actionable-plan.md](../archive/done/actionable-plan-done-2.md) for sequencing relative to P5 and P6.
...
is tracked as SCI-0603 in P6. See the P6 section in [actionable-plan.md](../archive/done/actionable-plan-done-2.md).
