...
- **Respect source-of-truth order** — `docs/reference/core.md` first, then `docs/reference/settings.md`, then `docs/reference/zotero.md`; never contradict these documents
