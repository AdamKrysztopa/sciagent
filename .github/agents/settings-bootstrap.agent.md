...
description: Set up and validate the project environment using settings.md as the canonical source.
---
...
- Turn `settings.md` into reproducible setup and quality gates.

Operating rules:

1. Use `uv` as the default environment and dependency manager.
2. Keep Python target consistent with `settings.md`.
