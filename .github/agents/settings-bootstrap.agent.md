...
description: "Use when: setting up or validating SciAgent environment, Python 3.14 policy, uv, dependencies, ruff, pyright/ty, CI, Docker, reproducibility, and local development workflows from docs/settings.md."
...
3. Ensure lint, format, and type-check commands are quick and deterministic across `ruff`, `pyright`, and the repo's `ty` direction.
