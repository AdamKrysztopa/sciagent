...
14. Validate add-on changes with `npm run build`, `npm run typecheck`, and `npm run test` from `zotero-addon/` unless the user explicitly narrows the validation scope.
