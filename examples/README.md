...
- M3 (implemented): `source .venv/bin/activate && python examples/m3_write_correctness_demo.py`
- M4 (implemented): `source .venv/bin/activate && python examples/m4_approval_flow_demo.py`
- M5 (implemented): `source .venv/bin/activate && python examples/m5_hardening_demo.py`
- M6 (implemented): `source .venv/bin/activate && python examples/m6_zotero_addon_demo.py`
...
- Zotero add-on quality job: `cd zotero-addon && npm ci && npm run build && npm run typecheck && npm run test`
